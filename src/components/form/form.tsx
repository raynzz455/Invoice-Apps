        ...
        <div className="flex flex-col flex-1 pr-4">
          <div className="flex flex-col justify-start mb-6">
            ...
            <input
              ...
              className={`mt-1 block w-full max-w-[50%] px-3 py-2 border-2 border-black rounded-md sm:text-xs ${validationErrors.includes('Folder Name is required.') ? 'border-red-500 shadow-[2.5px_2.5px_0px_red]' : 'border-black shadow-[3.5px_3.5px_0px_black]'}`}
            />
          ...
          <div className="flex flex-col gap-4 mb-6">
            <div className="flex flex-col">
              ...
              <input
                ...
                className={`mt-1 block w-full px-3 py-2 border-2 border-black rounded-md shadow-md sm:text-xs ${validationErrors.includes('Bank Name is required.') ? 'border-red-500 shadow-[2.5px_2.5px_0px_red]' : 'border-black shadow-[3.5px_3.5px_0px_black]'}`}
              />
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                maxLength={14}
                className={`mt-1 block w-full px-3 py-2 border-2 border-black rounded-md shadow-md sm:text-xs ${validationErrors.includes('Account Number is required.') ? 'border-red-500 shadow-[2.5px_2.5px_0px_red]' : 'border-black shadow-[3.5px_3.5px_0px_black]'}`}
              />
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                className={`mt-1 block w-full px-3 py-2 border-2 border-black rounded-md shadow-md sm:text-xs ${validationErrors.includes('Account Holder Name is required.') ? 'border-red-500 shadow-[2.5px_2.5px_0px_red]' : 'border-black shadow-[3.5px_3.5px_0px_black]'}`}
              />
        ...
        <div className="flex flex-col flex-1 pl-4">
          <div className="flex flex-col mb-6">
            ...
            <input
              ...
              className={`mt-1 block w-full px-3 py-2 border-2 border-black rounded-md shadow-md sm:text-xs ${validationErrors.includes('Recipient Name is required.') ? 'border-red-500 shadow-[2.5px_2.5px_0px_red]' : 'border-black shadow-[3.5px_3.5px_0px_black]'}`}
            />
          ...
          <div className="flex gap-4 mb-6">
            <div className="flex flex-col flex-1">
              ...
              <input
                ...
                className={`mt-1 block w-full px-3 py-2 border-2 border-black rounded-md shadow-md sm:text-xs ${validationErrors.includes('Address is required.') ? 'border-red-500 shadow-[2.5px_2.5px_0px_red]' : 'border-black shadow-[3.5px_3.5px_0px_black]'}`}
              />
            ...
            <div className="flex flex-col flex-1">
              ...
              <input
                ...
                className={`mt-1 block w-full px-3 py-2 border-2 border-black rounded-md shadow-md sm:text-xs ${validationErrors.includes('Job Description is required.') ? 'border-red-500 shadow-[2.5px_2.5px_0px_red]' : 'border-black shadow-[3.5px_3.5px_0px_black]'}`}
              />
          ...
          <div className="flex gap-4 mb-6">
            <div className="flex flex-col flex-1">
              ...
              <input
                ...
                className={`mt-1 block w-full px-3 py-2 border-2 border-black rounded-md shadow-md sm:text-xs ${validationErrors.includes('Invoice Number is required.') ? 'border-red-500 shadow-[2.5px_2.5px_0px_red]' : 'border-black shadow-[3.5px_3.5px_0px_black]'}`}
              />
            ...
            <div className="flex flex-col flex-1">
              ...
              <input
                ...
                className={`mt-1 block w-full px-3 py-2 border-2 border-black rounded-md shadow-md sm:text-xs ${validationErrors.includes('Date is required.') ? 'border-red-500 shadow-[2.5px_2.5px_0px_red]' : 'border-black shadow-[3.5px_3.5px_0px_black]'}`}
              />
